...
class SleeveLengthScreen extends StatefulWidget {
  ...
  @override
  State<SleeveLengthScreen> createState() => _SleeveLengthScreenState();
}
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          _buildHeader(),
          _buildStepIndicator(),
          Expanded(child: _buildSleeveOptions()),
        ],
      ),
  ...
  Widget _buildSleeveOptionCard(
    ...
    return Container(
      ...
      child: InkWell(
        onTap: () {
          setState(() {
            _selectedSleeveLength = sleeveOption['length'];
          });
        },
        borderRadius: BorderRadius.circular(16),
        child: Padding(
  ...
  Widget _buildNextStepButton() {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: _selectedSleeveLength == null
            ? null
            : () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => CollarTypeScreen(
                      ...
                      sleeveData: _sleeveOptions.firstWhere(
                        (option) => option['length'] == _selectedSleeveLength,
                      ),
                    ),
                  ),
                );
        ...
        style: ElevatedButton.styleFrom(
          ...
          backgroundColor: _selectedSleeveLength == null
              ? AppColors.textLight
              : AppColors.primary,
          ...
          elevation: _selectedSleeveLength == null ? 0 : 4,
        ),
        child: const Text(
          'Pilih Kerah',
